...
public partial class AdminPage : System.Web.UI.Page
{
    ...
    protected void addproduct_Click(object sender, EventArgs e)
    {
        if (uploadimage() == true)
        {
            String query = "insert into products(p_cmake,p_cmodel,sparepart,p_description,price,quantity,p_imgurl) values('" + cmaketb.Text + "','" + cmodeltb.Text + "','" + sparttb.Text + "','" + descript.Text + "'," + pricee.Text + "," + quanti.Text + ",'" + imagelink + "')";
